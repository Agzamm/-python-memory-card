...
questions_list.append(
        Question('на каком языке можно сделать программу?', 'Язык программированя', 'Английский', 'Испанский', 'Русский'))
questions_list.append(
        Question('Какого цвета крокодил?', 'Зелёный', 'Красный', 'Белый', 'Синий'))
questions_list.append(
        Question('Главный Певец группы "Кино"? ', 'Виктор Цой', 'Горшков', 'Монгрештерн', 'Павел Дуров'))
